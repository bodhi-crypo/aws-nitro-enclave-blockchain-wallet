...
| 指标 | v1 | v2 | 对比 |
| --- | --- | --- | --- |
| `total_requests` | `2312` | `301` | v2 约为 v1 的 `13.0%` |
| `successful_requests` | `2311` | `301` | v1 有 `1` 次失败，v2 为 `0` |
| `failed_requests` | `1` | `0` | v2 更稳定 |
| `elapsed_seconds` | `15.167` | `18.33` | v2 总耗时更长 |
| `tps` | `152.374` | `16.421` | v2 吞吐约为 v1 的 `10.8%`，v1 约为 v2 的 `9.28x` |
| `latency_ms_avg` | `51.993` | `414.473` | v2 平均延迟约为 v1 的 `7.97x` |
| `latency_ms_p50` | `45.446865` | `355.565668` | v2 中位延迟约为 v1 的 `7.82x` |
| `latency_ms_p95` | `45.944895` | `374.058428` | v2 `p95` 约为 v1 的 `8.14x` |
| `latency_ms_p99` | `46.670864` | `1360.693787` | v2 `p99` 约为 v1 的 `29.16x` |
| `latency_ms_min` | `7.908026` | `48.674712` | v2 最短请求也明显更慢 |
| `latency_ms_max` | 未记录 | `9718.514533` | v2 存在长尾尖峰 |

结论上，`v2` 引入 KMS 包裹与恢复后，吞吐相比 `v1` 明显下降，延迟也整体抬高。
